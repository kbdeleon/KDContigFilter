...
from KDContigFilter.KDContigFilterImpl import KDContigFilter
from KDContigFilter.KDContigFilterServer import MethodContext
from KDContigFilter.authclient import KBaseAuth as _KBaseAuth

from AssemblyUtil.AssemblyUtilClient import AssemblyUtil

class KDContigFilterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('KDContigFilter'):
        ...
        cls.serviceImpl = KDContigFilter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_KDContigFilter_" + str(suffix)
